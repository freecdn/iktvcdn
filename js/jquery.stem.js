function isMatch(str1) {
    var s = 'localhost,www.iktv8.com,m.iktv8.com.tv.com'
...
var ikan = {
	...
	swiper: function() {
		$.getScript(maccms.path + "/template/ikan/js/swiper.min.js", function() {
	...
	wrapper: function() {
		var windowWidth = $(window).width();
		if (windowWidth < 820) {
		$.getScript(maccms.path + "/template/ikan/js/iscroll.js", function() {
	...
	images: {
		lazyload: function() {
			$.getScript(maccms.path + "/template/ikan/js/jquery.lazyload.min.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 20,
		...
		qrcode: function() {
			$.getScript(maccms.path + "/template/ikan/js/jquery.qrcode.min.js", function() {
				$(".cans").qrcode({
					width:120,
					height:120,
	...
	copy: function() {
		$.getScript(maccms.path + "/template/ikan/js/clipboard.min.js", function() {
